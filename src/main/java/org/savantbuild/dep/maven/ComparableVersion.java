 ...
 * @see <a href="https://github.com/apache/maven/blob/39be5ef43a5079fc7573b74ac487c213f0606ed2/compat/maven-artifact/src/main/java/org/apache/maven/artifact/versioning/ComparableVersion.java">
 *   src/main/java/org/apache/maven/artifact/versioning/ComparableVersion.java
 *   </a>
 */
public class ComparableVersion implements Comparable<ComparableVersion> {
   ...
   * <pre>java -jar
   * ${maven.repo.local}/org/apache/maven/maven-artifact/${maven.version}/maven-artifact-${maven.version}.jar "1.2.7"
   * "1.2-SNAPSHOT"</pre>
  ...
  /**
   * Represents a combination in the version item list. It is usually a combination of a string and a number, with the
